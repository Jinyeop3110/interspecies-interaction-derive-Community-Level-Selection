...
| b | Simulated outcomes in similarity space at μ = 0.6 | Generated by `make_panels.py` |
| c | Interaction coefficients before and after assembly | Generated by `make_panels.py` |
| d | Pairwise selection correlation, within vs across parental communities | Generated by `make_panels.py` |

```bash
python pipeline/04_figure_generation/fig2/make_panels.py --replicates 300
```
